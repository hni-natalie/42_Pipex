...
/*   Updated: 2024/11/25 10:06:32 by hni-xuan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libft.h"

// ft_striteri doesn't return anything and works 
// directly on the original string
// It can only use char array in the main body
// However, it can't use pointer as pointer point 
// to the particular memory address
// ft_striteri change the original string and 
// so change the memory address

/**
 * @brief function that apply a function to each character of a string
 * each character is transmitted by address to 
